...
class ConversationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['summary', 'created_at', 'updated_at', 'messages'] # These fields are read-only and cannot be modified through the API. DRF’s ModelSerializer will auto-treat any auto-generated primary key (like id) as read-only.
        '''
...
class SendMessageSerializer(serializers.Serializer):
    message = serializers.CharField(
        max_length=2000,
        help_text="The user’s chat text to send to the bot"
    )
